...
#+NAME: get-setting
#+begin_src emacs-lisp :var name="nil"
...
;; Fonts
"font-nerd-symbols" ;; Symbols Nerd Font Mono
"font-ibm-plex"
"font-fira-code"
"font-fira-mono"
"font-jetbrains-mono"
...
modules-right = telegram mu4e cpu memory temperature battery date
...
Elisp functions for managing desktop from emacs.

#+begin_src emacs-lisp :tangle ~/.doom.d/modules/desktop/exwm/+desktop.el

(defun nanjigen/run-setxkbmap ()
  (interactive)
...
(defun nanjigen/update-wallpapers ()
  ...
  (start-process-shell-command
   "feh" nil
   (format "feh --bg-scale ~/Pictures/backgrounds/%s" (alist-get 'desktop/background nanjigen/system-settings))))
...
(define redshift
  ...
  '(redshift)
    #:respawn? #t
    #:start (make-forkexec-constructor '("redshift" "-l" "35.71:139.79"))
    #:stop  (make-kill-destructor)))
...
(define fcitx5
  ...
  '(fcitx5)
    #:respawn? #t
    #:start (make-forkexec-constructor '("fcitx5"))
    #:stop  (make-kill-destructor)))
...
(register-services gpg-agent mcron syncthing redshift fcitx5 pulseaudio)
; Start the desired services automatically
(start-in-the-background '(gpg-agent mcron syncthing redshift fcitx5 pulseaudio))
#+end_src
